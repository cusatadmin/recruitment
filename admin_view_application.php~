<?php
	...
	$candidate_name = $row1->firstname." ".$row1->lastname;
...
function goBack() {
  window.history.back();
	...
	function post_in_eligibility($sid) {
		$("#loaderIcon").show();
			jQuery.ajax({
				url: "post_in_eligibility.php",
				data: {appn_id: $sid, reason: $("#ineligible_reason").val()},
				type: "POST",
				success:function(data){
                            ...
                            <div class="pro-con-table">
                                ...
                                <table class="responsive-table bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>If not Eligible, Enter Reason</td>
                                            <td>:</td>
                                            <td>
                            						...
                            						<form class="form-inline" action="#" method="POST">
															  <div class="form-group col-xs-4">
															    ...
															    id="ineligible_reason" value="<?php echo $row->ineligible_reason; ?>">
															  </div>
															  
															  <button type="submit" class="btn btn-primary btn-xs" 
															  id="submit" onclick="post_in_eligibility('<?php echo $row->appn_id; ?>')">Submit</button>
															</form>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                            <a href="admin_candidate_print_to_pdf.php?<?php echo "notifid=".$row->notifid."&emailid=".$emailid;?>" target="_blank">
