...
$page = (int)$_REQUEST['page'];
		if($page=="")
			$page = 1;
	$query = "select count(*) as counted from notifications where closed=0 and display=1" ;
	//echo $query;
...
// Pagination end
   ...
   $query = "SELECT * from notifications where closed=0 and display=1 order by last_date_online limit $records_from, $records_limit";
	$stmt = $conn->prepare($query);
