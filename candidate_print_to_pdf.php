...
//get awards
	...
	$pdf->SetFont('Arial','B',14);
		...
		$pdf->Cell(190,10,'PART A - APPLICATION FORM',0,1,'C');
		...
		$notif_number_date = $notif->notif_number_date." dtd. ".date("d/m/Y", strtotime($notif->notification_date));
		$pdf->Cell(120,5,$notif_number_date,0,1,'L');
		...
		$pdf->SetFont('Arial','',10);
		$pdf->Cell(50,10,'Religion & Community',1,0,'L');
		$pdf->SetFont('Times','B',10);
		$pdf->Cell(135,10,$row->religion,1,1,'L');
