<?php 
	...
	if ($_POST['submit'] == "Upload Ranklist") {
...
// upload file
		...
		if ( !empty($fileName) ) {
			...
			// write to database
			$query = "UPDATE notifications set ranklist = '$file_upload_name' where notifid = '$entry'";	
