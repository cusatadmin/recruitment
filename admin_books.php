...
<div class="stu-db">
            <div class="container pg-inn">
                <div class="col-md-12">
							<h4 align="center">Books Published by <?php echo $candidate_name; ?></h4>
                                ...
                                <table class="bordered table-responsive  table-condensed">
                                    ...
                                    <?php 	while ($row = $result->fetch_object()) {	?>
                                        <tr>
                                            ...
                                            <td>
                                            <!-- change score begin -->
                                            <form id="UserDisplayForm" action="change_book_score.php" method="POST">
															<div class="input text">
															   <input type="text" class="form-control" 
															   value="<?php echo $row->book_score; ?>" 
