                                   ...
                                   <div class="row">
                                     ...
                                     <div class="col-md-6">
                                       <div class="text-right"> <span>
                                         <div class="form-group field-academic-totalpoints has-success">
                                         ...
                                         Points : <span id="x-total-points-acadmic-du">0</span></span>
                                         <!-- <span> -->
                                       </div>
                                     </div>
                                   </div>
                                   ...
                                   <table class="table table-striped">
                                     <tbody>
                                       ...
                                       <tr>
                                         ...
                                         <td><div id="tenthPercent">
                                           <div class="form-group field-academic-temptenthpercentage">
                                           ...
                                           <div id="tenthGrade" style="display: none;">
                                             <div class="form-group field-academic-temptenthgrade">
                                       ...
                                       <tr>
                                         ...
                                         <td><div id="twelthPercent">
                                           <div class="form-group field-academic-temptwelthpercentage">
                                           ...
                                           <div id="twelthGrade" style="display: none;">
                                             <div class="form-group field-academic-temptwelthgrade">
                                   ...
                                   <div id="form-area-tab-22">
                                     ...
                                     <div class="row">
                                         ...
                                         <tbody>
                                           ...
                                           <tr>
                                             ...
                                             <td><div class="form-group field-academic-ugcollege">
                                               ...
                                               <div class="form-group field-academic-ug_other_degree">
                                           ...
                                           <tr>
                                             ...
                                             <td><div class="form-group field-academic-pgcollege required">
                                               ...
                                               <div class="form-group field-academic-pg_other_degree">
                                       ...
                                       <table class="table">
                                         <tbody>
                                           <tr>
                                             <th rowspan="2"> <div>M.Phil. </div>
                                               <div class="form-group field-academic-mphilna required has-success">
                                                 ...
                                                 <div id="academic-mphilna" role="radiogroup" required="true" aria-invalid="false">
                                                   <input type="radio"   class="filled-in" name="mphilna" value="false" selected="selected" id="mphilno" />
                                                   <label for="mphilno"> No</label>
                                                   <input type="radio"  class="filled-in"  name="mphilna" value="true" id="mphilyes" />
                                                   <label for="mphilyes"> Yes</label>
                                                 </div>
                                                 <div class="invalid-feedback"> This field cannot be blank </div>
                                               </div></th>
                                             <td colspan="6"><div class="col-md-3 col-xs-6">
...
<option value="M.Phil.">M.Phil.</option>
                                           ...
                                           <tr>
                                             <td style="width:10%;"><div class="form-group field-academic-mphilstartdate has-success" style="display: none;">
                                               <label class="control-label" for="academic-mphilstartdate">Date of Registration/Admission</label>
                                               <input type="text" id="academic-mphilstartdate" class="form-control hasDatepicker" name="mphilstartdate" value="01/01/1970" placeholder="Date of Registration" disabled="disabled" aria-invalid="false" />
                                             ...
                                             <td style="width:10%;"><div class="form-group field-academic-mphilsubmissiondate" style="display: none;">
                                               <label class="control-label" for="academic-mphilsubmissiondate">Date of Submission</label>
                                               <input type="text" id="academic-mphilsubmissiondate" class="form-control hasDatepicker" name="mphilsubmissiondate" value="01/01/1970" placeholder="Date of Submission" disabled="disabled" />
                                               <div class="invalid-feedback"> This field cannot be blank </div>
                                             </div></td>
                                             <td style="width:10%;"><div class="form-group field-academic-mphilawarddate has-success" style="display: none;">
                                               <label class="control-label" for="academic-mphilawarddate">Date of Award</label>
                                               <input type="text" id="academic-mphilawarddate" class="form-control hasDatepicker" name="Academic[mphilAwardDate]" value="01/01/1970" placeholder="Date of Award" disabled="disabled" aria-invalid="false" />
                                               <div class="invalid-feedback"> This field cannot be blank </div>
                                             </div></td>
                                             <td style="width:30%;"><div class="form-group field-academic-mphilthesistitle" style="display: none;">
                                               ...
                                               <textarea id="academic-mphilthesistitle" class="form-control" name="mphilthesistitle" rows="3" disabled="disabled"></textarea>
                                               <div class="invalid-feedback"> This field cannot be blank </div>
                                             </div></td>
                                             <td><div class="form-group field-academic-mphiluniversity" style="display: none;">
                                               ...
                                               <input type="text" id="academic-mphiluniversity" class="form-control" name="mphiluniversity" value="" maxlength="255" disabled="disabled" />
                                               <div class="invalid-feedback"> This field cannot be blank </div>
                                             </div>
                                               <div class="form-group field-academic-mphilpercentage" style="display: none;">
                                                 <label class="control-label" for="academic-mphilpercentage">Overall Percentage
                                                   <!--/Grade Points <span style="font-size:10px">(Out of 10)</span>-->
                                                 </label>
                                                 <input type="text" id="academic-mphilpercentage" class="form-control" name="mphilpercentage" value="" disabled="disabled" />
                                           ...
                                           <tr>
                                             <th rowspan="2" style="width:10%;"> <div>Ph.D. </div>
                                               <div class="form-group field-academic-phdna required">
                                                 <label class="control-label"></label>
                                                 <input type="hidden" name="Academic[phdNA]" value="1" id="academic-phdval" />
                                                 <div id="academic-phdna" role="radiogroup" required="true">
                                                   <input type="radio" name="phdna" value="false" selected="selected"  id="phdno"= class="filled-in" />
                                                   <label for="phdno"> No</label>
                                                   <input type="radio" name="phdna" value="true" selected="selected" id="phdyes" class="filled-in" />
                                                   <label for="phdyes"> Yes</label>
                                                 </div>
                                                 <div class="invalid-feedback"> This field cannot be blank </div>
                                               </div></th>
                                             <td style="width:10%;"><div class="form-group field-academic-phdregdate has-success" style="display: none;">
                                             ...
                                             <td style="width:10%;"><div class="form-group field-academic-phdsubdate" style="display: none;">
                                             ...
                                             <td style="width:10%;"><div class="form-group field-academic-phdawarddate has-success" style="display: none;">
                                             ...
                                             <td style="width:20%;"><div class="form-group field-academic-phduniversity" style="display: none;">
                                               ...
                                               <input type="text" id="academic-phduniversity" class="form-control" name="phduniversity" value="" maxlength="255" disabled="disabled" />
                                           ...
                                           <tr style="display: none;">
                                             ...
                                             <td colspan="2"><div class="form-group field-academic-otitle">
                                             ...
                                             <td><div class="form-group field-academic-odatesub">
                                               ...
                                               <input type="text" id="academic-odatesub" class="form-control hasDatepicker" name="academic_odatesub" value="" readonly="readonly" placeholder="Date of Award" />
                                               <div class="invalid-feedback"> This field cannot be blank </div>
                                             </div></td>
                                             ...
                                             <td><div class="form-group field-academic-ouniversity">
                                               ...
                                               <div class="form-group field-academic-opercentage">
                                           ...
                                           <tr>
                                             ...
                                             <td><div id="pns-net-subject">
                                               ...
                                               <div id="pns-net-exe-block" style="display: none"><span style="color:red; "> </span> </div></td>
                                             <td><div id="pns-net-certificate">
                                           ...
                                           <tr>
                                             <td colspan="6"><div id="net-fr" style="display: none;">
                                           ...
                                           <tr>
                                             <td colspan="7"><strong><sup> * </sup>Candidate with Grade Point Average result should convert it into
                                               overall percentage.</strong></td>
                                           </tr>
                                         </tbody>
                                       </table>
                                     </div>
                                 ...
                                 <div class="panel-footer text-center"> <a id="exp-next-btn-3" class="btn btn-success" href="experience_info.php">Proceed to Next Section</a></div>
                               </div>
                             </form>
                              </div>
 </div>
