            ...
            <div class="row">
                <div class="cor about-sp">
                    <div class="ed-about-tit">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="ho-ev-link pg-eve-desc">
                                           ...
                                           <i class="fas fa-map-marker-alt"></i>cirm
                                        </div>
                                        <div class="pg-eve-reg">
                                            <a href="event-details.php">Read more</a>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <div class="ho-ev-link pg-eve-desc">
                                            ...
                                            <i class="fas fa-map-marker-alt"></i>International School of Photonics
                                        </div>
                                        <div class="pg-eve-reg">
                                            <a href="event-details.php">Read more</a>
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="ho-ev-link pg-eve-desc">
                                           ...
                                           <i class="fas fa-map-marker-alt"></i>School of Engineering
                        ...
                        <div class="pg-pagina">
                            <ul class="pagination">
                                <li class="disabled"><a href="#!" class="fa fa-angle-left" aria-hidden="true"></a></li>
                                <li class="active"><a href="#!">1</a></li>
                                <li class="waves-effect"><a href="#!">2</a></li>
                                <li class="waves-effect"><a href="#!">3</a></li>
                                <li class="waves-effect"><a href="#!">4</a></li>
                                <li class="waves-effect"><a href="#!">5</a></li>
                                <li class="waves-effect"><a href="#!" class="fa fa-angle-right" aria-hidden="true"></a></li>
                            </ul>
