...
require '../../../contract _fac_cucek1/PHPMailer_v5.1/test/PHPUnit/Framework.php';
...
class phpmailerTest extends PHPUnit_Framework_TestCase {
	...
	@include '../../../contract _fac_cucek1/PHPMailer_v5.1/test/testbootstrap.php'; //Overrides go in here
