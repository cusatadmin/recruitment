                         ...
                         <div class="row">
                            ...
                            <div class="text-danger small"><em>Category</em></div>
                            	<select name="phd_category" id="phd_category"  class="custom-select browser-default" required>
                                    <option value="Guide <?php if ($row->phd_category=='Guide') echo "Selected"; ?>" >Guide</option>
                                    <option value="Co-Guide" <?php if ($row->phd_category=='Co-Guide') echo "Selected"; ?>>Co-Guide</option>
                                    <option value="Scholar" <?php if ($row->phd_category=='Scholar') echo "Selected"; ?>>Scholar</option>
                                 </select>
                         	</div>
                              <div class="col-md-6">
