<?php 
	...
	$entry=$_GET['entry'];
	$query = "SELECT * FROM experience where exp_id='$entry'";
...
//experience Upload;
	...
	$file_upload_name = "EXP_".$entry."_".$emailid.".".$file_Extension;
	//echo $file_Name;
                      ...
                      <form class="form-inline" action="#" method="post" name="editme" enctype="multipart/form-data" >
                         ...
                         <div class="row">
                            ...
                            <div class="text-danger small"><em>Category</em></div>
                                 ...
                                 <select name="exp_category" id="exp_category"  class="custom-select browser-default" required>
                                    <option value="Teaching"<?php  if ($row->exp_category=="Teaching" ) echo  "Selected"; ?> >Teaching</option>
                                    <option value="Research" <?php  if ($row->exp_category=="Research" ) echo  "Selected"; ?>>Research</option>
                                    <option value="Others"  <?php  if ($row->exp_category=="Others" ) echo  "Selected"; ?>>Other Experiences</option>
                                 </select>
                              ...
                              <div class="text-danger small"><em>Designation</em></div>
                              	<input type="text" value="<?php echo $row->exp_designation; ?>" name="exp_designation" id="exp_designation" class="validate" placeholder="Designation" required>
                            </div>
                       	</div> <!-- row -->
                        ...
                        <div class="row">
                            ...
                            <div class="text-danger small"><em>Start Date</em></div>
                              	<input type="date" id="exp_from_date" name="exp_from_date" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" required="" value="<?php echo $row->exp_from_date; ?>" > (mm/dd/yyyy)
                            </div>
                            <div class="col-md-6">
                            <div class="text-danger small"><em>End Date</em></div>
                              	<input type="date" id="exp_to_date" name="exp_to_date" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" required="" value="<?php echo $row->exp_to_date; ?>" > (mm/dd/yyyy)
                              </div>
                         ...
                         <div class="row">
                            ...
                            <div class="text-danger small"><em>Employer</em></div>
                              	<input type="text" value="<?php echo $row->exp_employer; ?>" name="exp_employer" id="exp_employer" class="validate"  placeholder="Employer" required>
                            </div>
                        </div> <!-- row -->
