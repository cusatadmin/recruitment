...
$auth = $_SESSION['admin'];
   ...
   if ($_POST['submit'] == "Add") {
	...
	$query = "INSERT INTO index_page 
			(short_title, description,priority, long_description, postdate) VALUES 
				('$short_title','$description','$priority','$editor1','$todays')";	
	//echo $query;
                  ...
                  <div class="box-inn-sp admin-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                              <div class="text-danger small">
                                ...
                                <input type="text" value="" name="priority" id="priority" class="validate" 
                                 placeholder="Display priority" required> 
                            </div>
                     ...
                     <div class="col-md-4">
                              <div class="text-danger small">
                           	 ...
                           	 <textarea class="form-control rounded-0" id="description" name="description" cols="80">
                                </textarea>
